...
class m210405_122952_backend_member extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%backend_member}}', [
            ...
            'department_id' => "int(11) NULL COMMENT '机构ID'",
            'role_id' => "int(11) NULL COMMENT '角色'",
        ...
        /* 表数据 */
        $this->insert('{{%backend_member}}',['id'=>'1','merchant_id'=>'0','department_id'=>NULL,'role_id'=>NULL,'username'=>'admin','password_hash'=>'$2y$13$WDA3Y7ojT9q0vFGSejY/Y.UFNgOoL2kBzL4fbRZG4hrdGOLNPv/r6','auth_key'=>'z6lrwixmdNF4VqtkXw6z-3vMZdSdngm2','password_reset_token'=>'','type'=>'10','realname'=>'YiiFrame','head_portrait'=>'','gender'=>'1','qq'=>'','email'=>'','birthday'=>'2020-01-01','province_id'=>'230000','city_id'=>'230300','area_id'=>'230302','address'=>'','mobile'=>'18986860000','home_phone'=>'','dingtalk_robot_token'=>'','visit_count'=>'114','last_time'=>'1617558788','last_ip'=>'127.0.0.1','role'=>'10','status'=>'1','created_at'=>'1449114934','updated_at'=>'1617558788']);
