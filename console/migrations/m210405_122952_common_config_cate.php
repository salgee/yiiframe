...
class m210405_122952_common_config_cate extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->insert('{{%common_config_cate}}',['id'=>'3','title'=>'网站基础','pid'=>'1','app_id'=>'backend','level'=>'2','sort'=>'0','tree'=>'tr_0 tr_1 ','status'=>'1','created_at'=>'1553908574','updated_at'=>'1553908611']);
