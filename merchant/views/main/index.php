...
<?php $this->beginPage() ?>
    ...
    <div class="wrapper">
        ...
        <?= $this->render('_left', [
            'manager' => Yii::$app->user->identity,
            'merchants' => Yii::$app->services->merchant->findById(Yii::$app->user->identity->merchant_id)
        ]); ?>
        <!-- 主体内容区域 -->
    ...
    <script>
        // 配置
        let config = {
            tag: "<?= Yii::$app->debris->getAllInfo(true, \common\enums\AppEnum::MERCHANT,  Yii::$app->services->merchant->getMerchantId())['sys_tags'] ?? false; ?>",
