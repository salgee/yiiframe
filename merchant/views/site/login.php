...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">账号密码见QQ群公告:1107210028</p>
        ...
        <?php ActiveForm::end(); ?>
        <?php if (!empty(Yii::$app->debris->addonConfig(true,'Merchants')['merchant_register_is_open'])) { ?>
            <div class="social-auth-links text-center">还没有帐号？<?= Html::a('申请入驻', ['register']); ?></div>
        <?php } ?>
