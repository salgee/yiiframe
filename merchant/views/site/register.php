...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg"><?= Html::encode(Yii::$app->debris->backendConfig('web_site_title')) ?> 企业入驻</p>
        ...
        ])->textInput(['placeholder' => '企业名称'])->label(false); ?>
        ...
        ])->textInput(['placeholder' => '企业简称'])->label(false); ?>
        <?= $form->field($model, 'cate_id')->dropDownList($cate, ['prompt' => '主营行业'])->label(false); ?>
        ...
        <div class="form-group field-signupform-rememberme has-error">
            ...
            <label>
                ...
                <?= '我同意' . \yii\helpers\Html::a('《企业入驻协议》', ['register-protocol'], [
                    'target' => '_blank',
                    'class' => 'blue'
                ])?>
            </label>
