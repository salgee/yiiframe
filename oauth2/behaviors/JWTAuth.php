...
use addons\Oauth\common\models\repository\AccessTokenRepository;
...
class JWTAuth extends Behavior
{
    ...
    public function beforeAction($event)
    {
        ...
        if ($user = Yii::$app->oauthService->accessToken->findByAccessToken($user['oauth_access_token_id'], $user['oauth_client_id'])) {
