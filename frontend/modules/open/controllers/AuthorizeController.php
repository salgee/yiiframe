...
use addons\Oauth\common\models\entity\UserEntity;
use addons\Oauth\common\models\repository\AuthCodeRepository;
use addons\Oauth\common\models\repository\RefreshTokenRepository;
use addons\Oauth\common\models\entity\ScopeEntity;
...
class AuthorizeController extends Controller
{
    ...
    public function init()
    {
        ...
        Yii::$app->oauthService->server->set($grant); // 写入服务
    }
    ...
    {
        $server = Yii::$app->oauthService->server->get();
